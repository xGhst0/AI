...
MODEL_SECONDARY="https://huggingface.co/alternate/path/to/$MODEL_NAME" # Replace with a real fallback if needed
...
sudo apt update -y && sudo apt install -y build-essential cmake curl git python3 python3-pip
